...
$bdao = new boardDao();
$msgs = $bdao->getAllBoard("rboard");


session_start();
                            
$_SESSION["nowBoard"] = "reviewBoard";
$board = "rboard";
   ...
   <?php
    ...
    <div class="slider-container">
        ...
        <div class="carousel-inner" style="height:300px">
            <img src="img/jelly2.JPG" style="width:100%;">
        </div>
        ...
        <div class="col-14 d-flex p-2 justify-content-end">
            <button type="submit" class="btn amy-crisp-gradient">글쓰기</button>
        </div>
    </form>
